...
const OAuth2Client = new OAuth2(configObj.google_client_id, configObj.google_client_secret);
		...
		<body>
			...
			<div>
				...
				<ul type="circle">
					...
					<li>
						<a href="${process.env.BASE_URL}/track/submission_being_processed" style="font-size: 16px;
							color: #007bff !important;
							text-decoration: none;"
				...
				<ul type="circle">
					...
					<li>
						<a href="${process.env.BASE_URL}/track/revision_in_process"style="font-size: 16px;
							color: #007bff !important;
							text-decoration: none;"
