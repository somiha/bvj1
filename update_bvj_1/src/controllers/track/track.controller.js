...
async function trackStateCounter(id) {
  ...
  const [
    submitted_paper,
    submission_being_processed,
    submission_needing_revision,
    revision_being_processed,
    declined_revision,
    submission_with_a_decision,
  ] = data;
    ...
    Promise.all(results).then(async (values) => {
      ...
      res.render("track", {
        ...
        submission_being_processed:
          submission_being_processed[0].submission_being_processed,
        submission_needing_nevision:
          submission_needing_nevision[0].submission_needing_nevision,
        revision_being_processed:
          revision_being_processed[0].revision_being_processed,
