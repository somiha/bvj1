...
const { REVIEW_DONE, NEED_REVISION, SENT_BACK_TO_AUTHOR } = require("../../enums/paperCheckpoints");
...
async function sendBackToAuthor(req, res){
  try {
    ...
    author_paper_update(paper_id, true, "Your paper has been sent back to you for revision");
